...
% Evaluates environmental control efficacy (Nitrogen)
% Range: 20°C to -110°C 
% =========================================================================
...
filename = 'ntype36_nitrogin_only_raw_data.xlsx';

% Define the temperature array: 20°C down to -110°C in 5-degree increments.
